      ...
      <main className="flex-1 flex flex-col min-w-0 bg-background/50">
        <header className="h-28 border-b border-border flex items-center justify-between px-12 bg-background/80 backdrop-blur-xl sticky top-0 z-50">
          <div className="space-y-1">
            <h1 className="text-2xl font-black text-foreground tracking-tighter uppercase">Tableau de Bord</h1>
          ...
          <div className="flex items-center gap-6">
            <div className="relative w-72 hidden md:block">
              ...
              <Input className="pl-12 rounded-2xl bg-muted border-border text-foreground h-12 focus:ring-primary focus:border-primary transition-all font-medium" placeholder="Rechercher..." />
            </div>
            <Button variant="ghost" size="icon" className="rounded-2xl h-12 w-12 bg-muted border border-border text-foreground hover:bg-muted/80 relative">
        ...
        <div className="p-12 space-y-12 overflow-y-auto custom-scrollbar">
          ...
          >
            {stats.map((stat) => (
              <motion.div key={stat.title} variants={itemVariants}>
                <Card className="bg-card border-border rounded-[2.5rem] overflow-hidden group hover:shadow-xl transition-all duration-500">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            {/* Recent Articles */}
            <Card className="lg:col-span-8 bg-card border-border rounded-[3rem] overflow-hidden">
              <CardHeader className="flex flex-row items-center justify-between p-10 pb-6 border-b border-border">
                <div className="space-y-1">
                  <CardTitle className="text-2xl font-black text-foreground tracking-tighter uppercase">Dernières Publications</CardTitle>
                  <p className="text-[10px] text-muted-foreground font-bold uppercase tracking-widest">Gérez vos contenus récents</p>
                </div>
              ...
              <CardContent className="p-0">
                <div className="divide-y divide-border">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="flex items-center justify-between p-8 hover:bg-muted/50 transition-all group">
                      <div className="flex items-center gap-6">
                        <div className="relative h-16 w-16 rounded-[1.25rem] overflow-hidden border border-border">
                        ...
                        <div className="space-y-1">
                          <p className="font-black text-foreground text-lg tracking-tight line-clamp-1 group-hover:text-primary transition-colors">L'innovation technologique en Afrique : tendances 2024</p>
                      ...
                      <div className="flex items-center gap-12">
                        <div className="text-right hidden sm:block">
                          <p className="text-lg font-black text-foreground">1.2k</p>
                          <p className="text-[9px] text-muted-foreground uppercase font-black tracking-widest">Lectures</p>
                        </div>
            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              <Card className="bg-card border-border rounded-[3rem] overflow-hidden">
                <CardHeader className="p-10 pb-6 border-b border-border">
                  <CardTitle className="text-xl font-black text-foreground tracking-tighter uppercase">Flux d'Activité</CardTitle>
                </CardHeader>
                      ...
                      <div key={i} className="flex gap-4 group">
                        ...
                        <div className="space-y-1">
                          <p className="text-sm text-foreground/80 leading-snug">
                            <span className="font-black text-foreground">Ibrahim K.</span> a commenté votre dernier article.
                          </p>
                          <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Il y a {i * 15} min</p>
                        </div>
                      </div>
                    ))}
                  </div>
