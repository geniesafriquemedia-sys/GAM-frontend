      ...
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
        <div className="flex items-center gap-6">
          ...
          <div className="space-y-1">
            <h1 className="text-3xl font-black text-foreground tracking-tighter uppercase italic">Nouvel Article</h1>
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <div className="bg-primary/5 rounded-[2.5rem] p-8 border border-primary/10 space-y-4">
            <div className="flex items-center gap-3 text-primary">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest">IA : Titres & SEO</span>
            </div>
