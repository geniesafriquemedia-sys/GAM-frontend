        ...
        <div className="prose prose-zinc lg:prose-xl max-w-none space-y-12">
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground font-medium leading-relaxed">
              Le site <strong>GAM (Génies D'Afrique Media)</strong> est édité par la société GAM MEDIA SAS, au capital de 1 000 000 FCFA, immatriculée au Registre du Commerce et des Sociétés de Yaoundé sous le numéro RC/YAO/2023/B/000.
            </p>
            <p className="text-muted-foreground font-medium leading-relaxed">
