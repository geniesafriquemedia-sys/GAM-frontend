      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-background">
        ...
        >
          <div className="space-y-2">
            <h2 className="text-4xl font-black text-foreground tracking-tighter">Inscription.</h2>
            <p className="text-muted-foreground font-medium">Rejoignez l'élite éditoriale africaine.</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="fullName" className="text-muted-foreground font-bold text-xs uppercase tracking-widest">Nom Complet</Label>
              <Input 
                id="fullName" 
            ...
            <div className="space-y-2">
              <Label htmlFor="email" className="text-muted-foreground font-bold text-xs uppercase tracking-widest">Email Professionnel</Label>
              <Input 
                id="email" 
                type="email" 
          ...
          <div className="pt-6 border-t border-border flex flex-col items-center gap-4">
            <p className="text-muted-foreground text-sm font-medium">
              Déjà un compte ?{" "}
              <Link href="/login" className="text-foreground font-black hover:text-primary transition-colors">Se connecter</Link>
            </p>
